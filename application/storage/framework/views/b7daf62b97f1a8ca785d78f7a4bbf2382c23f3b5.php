					...
					<div class="row mt-2">
						<div class="col s12">
							<div class="input-field">
								...
								<select name="especialidade" id="especialidade" data-url="<?php echo e(go('clinica.especialidades.autocomplete')); ?>" data-placeholder="Informe a especialidade...">
					...
					<div class="row mt-2">
						<div class="col s12">
							<div class="input-field">
								...
								<select name="clinica" id="clinica" data-url="<?php echo e(go('clinica.clinicas.autocomplete')); ?>" data-placeholder="Informe a clínica...">
					...
					<div class="row">
						<div class="col s12">
							<div class="input-field">
								...
								<select name="medico" id="medico" data-url="<?php echo e(go('clinica.medicos.autocomplete')); ?>" data-placeholder="Informe o médico...">
					...
					<div class="row">
						<div class="col s12">
							<div class="input-field">
								...
								<select name="tipo" id="tipo" data-url="<?php echo e(go('clinica.atendimentos.autocomplete', 'tipos')); ?>" value="<?php echo e(isset($row) && $row->tipo_atendimento ? $row->tipo_atendimento : null); ?>" data-placeholder="Informe o tipo de atendimento...">
					...
					<div class="row">
						<div class="col s12">
							<div class="input-field">
								...
								<select name="categoria" id="categoria" data-url="<?php echo e(go('clinica.atendimentos.autocomplete', 'categorias')); ?>" data-placeholder="Informe a classificação do atendimento...">
										...
										<div class="col s12">
											<div class="input-field">
												...
												<?php if(isset($row) || !isset($paciente)): ?>
													<select name="nome_paciente" id="nome_paciente" data-url="<?php echo e(go('clinica.pacientes.autocomplete')); ?>" data-placeholder="Informe o paciente">
