<?php $__env->startSection('prev-url', route('clinica.clinicas.index')); ?>
...
<div class="container pt-1">
	<div class="row">
		<div class="col s12">
			<form action="<?php echo e(go('clinica.clinicas.post')); ?>" method="post" enctype="multipart/form-data" autocomplete="random-string" novalidate>
				...
				<div class="card">
												...
												<div class="row">
													<div class="col s12 m6">
														<div class="input-field">
															...
															<input type="text" name="razao_social" id="razao_social" value="<?php echo e($row->razao_social ?? null); ?>" autocapitalize="true">
														</div>
													</div>
													<div class="col s12 m6">
														<div class="input-field">
															...
															<input type="text" name="titulo" id="titulo" value="<?php echo e($row->titulo ?? null); ?>" autocapitalize="true">
														</div>
													</div>
												</div>
												<div class="row">
															...
															<?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<?php if(isset($row)): ?>
																	...
																	<tr>
																		...
																		<td><?php echo e($departamento->titulo); ?></td>
					...
					<div class="card-action right-align">
						...
						<button type="reset" class="btn white black-text waves-effect mr-2" data-tooltip="Voltar" data-href="<?php echo e(go('clinica.clinicas.index')); ?>">
