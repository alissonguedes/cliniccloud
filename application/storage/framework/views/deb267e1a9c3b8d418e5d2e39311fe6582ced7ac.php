...
<button class="btn btn-floating gradient-45deg-deep-orange-orange waves-effect waves-light z-depth-3" data-url="<?php echo e(go('clinica.departamentos.add')); ?>" data-trigger="modal" data-target="modal_departamento" data-tooltip="<?php echo $__env->yieldContent('btn-add-title'); ?>" data-position="left" data-href="<?php echo $__env->yieldContent('btn-add-route'); ?>">
		...
		<div class="card">
			<div class="card-content scroller">
				<div class="card-body responsive-table">
					<table class="table dataTable no-footer dataTable-fixed" data-link="<?php echo e(go('clinica.departamentos.index')); ?>">
						<thead>
							<tr>
