	...
	<div class="slider fullscreen">
		<div class="slider-fixed">
			<ul class="slides">
				<?php for($i = 1; $i <= 2; $i ++ ): ?>
					<li>
						<img src="<?php echo e(asset('img/site/banner/' . $i . '.png')); ?>" alt="">
					</li>
				<?php endfor; ?>
			</ul>
		</div>
	...
	<div class="col s12">
		...
		<div class="container pt-10">
			...
			<div class="row">
				...
				<div class="col l7">
					<img src="<?php echo e(asset('img/site/banner/1.png')); ?>" alt="" class="responsive-img z-depth-4 border-radius-10">
				</div>
			...
			<div class="row">
				<div class="col s12 m6 l4 mb-3">
					<div class="card-panel border-radius-10 mt-10 card-animation-1">
						<img src="<?php echo e(asset('img/site/banner/1.png')); ?>" alt="" class="responsive-img border-radius-8 z-depth-4 image-n-margin">
						<h6 class="card-title">
						...
						<div class="card card-border center-align red darken-2 border-radius-10">
							<div class="card-content white-text">
								<div class="avatar circle z-depth-4 mt-6 mb-6">
									<img class="responsive-img" src="<?php echo e(asset('img/site/usuarios/'. $i . '.jpg')); ?>" alt="">
								</div>
		...
		<div class="container pb-6 pt-6">
			<div class="row">
				<div class="col s12 m6 l4 center-align">
					...
					<h4 class="mt-10 white-text bold text-uppercase"> + <?php echo e(rand(2000, 9999)); ?></h4>
...
<?php echo $__env->make('main.body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alissonp/www/transvida/application/resources/views/main/home/index.blade.php ENDPATH**/ ?>