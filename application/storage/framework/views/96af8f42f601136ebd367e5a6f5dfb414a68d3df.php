												...
												<div class="row">
													...
													<div class="col s12 m4 l6">
														<div class="input-field">
															...
															<input type="text" name="data_nascimento" data-mask="date" value="<?php echo e($row->data_nascimento ?? null); ?>" placeholder="dd/mm/yyyy" data-max-date="<?php echo e(date('d/m/Y')); ?>">
														</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													<div class="col s12 m4 l4">
														<div class="input-field">
															...
															<input type="tel" name="cpf" id="cpf" data-mask="cpf" maxlength="14" value="<?php echo e($row->cpf ?? null); ?>">
														</div>
													</div>
													<div class="col s12 m4 l4">
														<div class="input-field">
															<label for="rg">RG</label>
															<input type="tel" name="rg" id="rg" maxlength="18" value="<?php echo e($row->rg ?? null); ?>">
														</div>
													</div>
													<div class="col s12 m4 l4">
														<div class="input-field">
															<label for="cns">CNS</label>
															<input type="tel" name="cns" id="cns" maxlength="18" value="<?php echo e($row->cns ?? null); ?>">
														</div>
													</div>
												</div>
												<div class="row">
										...
										<div class="row">
											...
											<div class="col s12 m3 l4">
												<div class="input-field">
													...
													<input type="tel" name="telefone" id="telefone" value="<?php echo e($row->telefone ?? null); ?>" data-mask="phone" maxlength="15">
												</div>
											</div>
											<div class="col s12 m3 l4">
												<div class="input-field">
													<label for="celular">Celular</label>
													<input type="tel" name="celular" id="celular" value="<?php echo e($row->celular ?? null); ?>" data-mask="celular" maxlength="16">
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="col s12 m3 l4">
												<div class="input-field">
													...
													<input type="text" name="validade_convenio" id="validade_convenio" value="<?php echo e($row->validade_convenio ?? null); ?>" data-mask="date" data-min-date="<?php echo e(date('d/m/Y')); ?>">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col s12 m3 l4">
												<div class="input-field">
													...
													<input type="tel" name="cep" id="cep" value="<?php echo e($row->cep ?? null); ?>" data-mask="cep">
												</div>
											</div>
									...
									<div id="observacoes">
										...
										<div class="row">
											<div class="col s12 m12 l12 mb-1">
												...
												<div id="notas_alergias" class="editor" data-placeholder="Alergias"><?php echo e($row->notas_alergias ?? null); ?></div>
											</div>
											<div class="col s12 m12 l12 mb-1">
												<label style="font-size: inherit;">Observações clínicas:</label>
												<div id="notas_clinicas" class="editor" data-placeholder="Notas clínicas" cols="30" rows="10"><?php echo e($row->notas_clinicas ?? null); ?></div>
											</div>
											<div class="col s12 m12 l12 mb-1">
												<label style="font-size: inherit;">Outras observações do paciente:</label>
												<div id="notas_gerais" class="editor" data-placeholder="Notas gerais" cols="30" rows="10"><?php echo e($row->notas_gerais ?? null); ?></div>
											</div>
										</div>
									</div>
									<!-- END #observacoes -->
												...
												<div class="row">
													<div class="col s4 m4 l12">
														<div class="input-field">
															...
															<input type="text" value="<?php echo e($row->data_obito ?? null); ?>" class="col s8 m4" name="data_obito" id="data_obito" data-mask="date" data-max-date="<?php echo e(date('d/m/Y')); ?>" placeholder="dd/mm/yyyy" <?php echo e(!$row || ($row && $row->obito == '0') ? 'disabled=disabled' : null); ?>>
															<input type="text" value="<?php echo e($row->hora_obito ?? null); ?>" class="col s4 m3" name="hora_obito" id="hora_obito" data-mask="time" placeholder="00:00" maxlength="5" <?php echo e(!$row || ($row && $row->obito == '0') ? 'disabled=disabled' : null); ?>>
														</div>
													</div>
												</div>
											</div>
