...
<a href="#" data-target="agendamento" data-link="<?php echo e(go('clinica.agendamentos.add')); ?>" class="form-sidenav-trigger btn btn-floating gradient-45deg-deep-orange-orange waves-effect waves-light z-depth-3" data-tooltip="Agendar">
			...
			<div class="card">
				<div class="card-content">
					<div class="card-title">
						<a href="#" data-target="agendamento" data-link="<?php echo e(go('clinica.agendamentos.add')); ?>" class="form-sidenav-trigger btn btn-floating gradient-45deg-deep-orange-orange waves-effect waves-light z-depth-3 hide" data-tooltip="Agendar">
							<i class="material-icons bolder">add</i>
						</a>
				...
				<div class="row">
					<div class="col s12">
						<div class="input-field">
							...
							<select name="filtro_categoria_atendimento" id="filtro_categoria_atendimento" data-url="<?php echo e(go('clinica.atendimentos.autocomplete', 'categorias')); ?>" data-placeholder="Tipo de atendimento" data-value="1">
				...
				<div class="row">
					<div class="col s12">
						<div class="input-field">
							...
							<select name="filtro_paciente" id="filtro_paciente" data-url="<?php echo e(go('clinica.pacientes.autocomplete')); ?>" data-placeholder="Nome do paciente"></select>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col s12">
						<div class="input-field">
							...
							<select name="filtro_medico" id="filtro_medico" data-url="<?php echo e(go('clinica.medicos.autocomplete')); ?>" data-placeholder="Nome do médico">
							</select>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col s12">
						<div class="input-field">
							...
							<select name="filtro_clinica" id="filtro_clinica" data-url="<?php echo e(go('clinica.clinicas.autocomplete')); ?>" data-placeholder="Nome do médico">
							</select>
						</div>
					</div>
				</div>
