<div class="row">
	<div id="modal_especialidade" class="modal modal-fixed-footer col s12 m4 l4 offset-m1 offset-l2" data-dismissible="false">
		<form action="<?php echo e(go('clinica.especialidades.post')); ?>" method="post" enctype="multipart/form-data" autocomplete="off" novalidade style="min-height: 400px;">
