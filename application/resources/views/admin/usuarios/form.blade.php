				...
				<div class="card">
					<div class="card-content no-padding">
												...
												<div class="row">
													...
													<div class="col s12 m4 l6">
														<div class="input-field">
															...
															<input type="text" name="data_nascimento" class="datepicker" data-mask="date" value="{{ $row->data_nascimento ?? null }}" placeholder="dd/mm/yyyy" data-max-date="{{ date('d/m/Y') }}">
														</div>
													</div>
												</div>
												<div class="row">
										...
										<div class="row">
											...
											<div class="col s12 m3 l4">
												<div class="input-field">
													...
													<input type="tel" name="celular" id="celular" value="{{ $row->celular ?? null }}" data-mask="phone2" maxlength="16">
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="col s12 m3 l4">
												<div class="input-field">
													...
													<input type="text" name="validade_convenio" class="datepicker" id="validade_convenio" value="{{ $row->validade_convenio ?? null }}" data-mask="date" data-min-date="{{ date('d/m/Y') }}">
												</div>
											</div>
										</div>
									</div>
						...
						<div class="card-action right-align">
							<button type="reset" class="btn white black-text waves-effect mr-2" data-tooltip="Voltar" data-position="top" data-href="{{ route('clinica.pacientes.index') }}">
