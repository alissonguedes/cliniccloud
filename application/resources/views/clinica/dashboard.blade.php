		...
		<div id="card-stats" class="pt-0">
			<div class="row">
				<div class="col s12 m6 l6 xl3">
					<a href="{{ go('clinica.pacientes.index') }}?obito=0">
							...
							<div class="padding-4">
								<div class="row">
									...
									<div class="col s5 m5 right-align">
										<h5 class="mb-0 white-text">{{ $total['pacientes']['vivos'] }}</h5>
				...
				<div class="col s12 m6 l6 xl3">
					<a href="{{ go('clinica.pacientes.index') }}?status=1&obito=0">
						<div class="card gradient-45deg-green-teal gradient-shadow min-height-100 white-text animate fadeLeft">
							<div class="padding-4">
								<div class="row">
									...
									<div class="col s5 m5 right-align">
										<h5 class="mb-0 white-text">{{ $total['pacientes']['ativos'] }}</h5>
				...
				<div class="col s12 m6 l6 xl3">
					<a href="{{ go('clinica.pacientes.index') }}?status=0&obito=0">
						<div class="card gradient-45deg-amber-amber gradient-shadow min-height-100 white-text animate fadeRight">
							<div class="padding-4">
								<div class="row">
									...
									<div class="col s5 m5 right-align">
										<h5 class="mb-0 white-text">{{ $total['pacientes']['inativos'] }}</h5>
				...
				<div class="col s12 m6 l6 xl3">
					<a href="{{ go('clinica.pacientes.index') }}?status=0&obito=1">
						<div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
							<div class="padding-4">
								<div class="row">
									...
									<div class="col s5 m5 right-align">
										<h5 class="mb-0 white-text">{{ $total['pacientes']['falecidos'] }}</h5>
							...
							<div class="row">
								<div class="col s12">
									<div class="yearly-revenue-chart">
										...
										<canvas id="thisYearRevenue" class="firstShadow chartjs-render-monitor" height="350" style="display: block; width: 772px; height: 350px;" width="772"></canvas>
										<canvas id="lastYearRevenue" height="350" width="772" style="display: block; width: 772px; height: 350px;" class="chartjs-render-monitor"></canvas>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col s12 m4 l4">
					<div id="weekly-earning" class="card animate fadeUp">
						<div class="card-content">
							...
							<canvas id="monthlyEarning" class="chartjs-render-monitor" height="150" width="351" style="display: block; width: 351px; height: 150px;"></canvas>
				...
				<div class="col s12 m4 l4">
					<div class="card pt-0 pb-0 animate fadeLeft">
						...
						<div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;">
							...
							<canvas id="custom-line-chart-sample-one" class="center chartjs-render-monitor" width="399" height="199" style="display: block; width: 399px; height: 199px;"></canvas>
						</div>
					</div>
				</div>
				<div class="col s12 m4 l4 animate fadeUp">
					<div class="card pt-0 pb-0">
						...
						<div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;">
							...
							<canvas id="custom-line-chart-sample-two" class="center chartjs-render-monitor" width="399" height="199" style="display: block; width: 399px; height: 199px;"></canvas>
						</div>
					</div>
				</div>
				<div class="col s12 m4 l4">
					<div class="card pt-0 pb-0 animate fadeRight">
						...
						<div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;">
							...
							<canvas id="custom-line-chart-sample-three" class="center chartjs-render-monitor" width="399" height="199" style="display: block; width: 399px; height: 199px;"></canvas>
						</div>
					</div>
				</div>
			</div>
