	...
	<div class="topbar-fixed topbar-color flex flex-auto z-depth-1">
		<div class="flex flex-auto flex-center">
			...
			<div class="action-buttons">
				...
				@section('btn-add')
				<button class="btn btn-floating gradient-45deg-deep-orange-orange waves-effect waves-light z-depth-3" data-tooltip="@yield('btn-add-title')" data-position="left" data-href="@yield('btn-add-route')" data-position="">
